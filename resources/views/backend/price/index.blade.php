...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('price.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Price</a>
    </div>
    <div class="card-body">
...
@push('scripts')
  ...
  <script>
      ...
      function format(d) {
          ...
          let list = '<div class="table-responsive"> <table class="table"> <thead> <th style="text-align:center;">Product</th> <th style="text-align:center;">Level Mitra</th> <th style="text-align:center;">Price Type</th> <th style="text-align:center;">Price</th> </thead>';
          d.forEach((row) => {
            console.log(row);
